...
| R7 | Scope creep from a good idea on D4 | Any good idea after D2 | Write it in a `LATER.md`. The catalogue integration is a lifetime revenue share — there is time after 09-20. |
