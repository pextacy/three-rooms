 ...
 * **blank white page** — the worst thing a judge with ninety seconds can be
 * shown, and indistinguishable from a site that is simply down.
 *
 * So: catch it, stay in the room's own palette, say what happened in the
 * underwriter's voice, and offer the one action that helps. The error itself is
...
export class ErrorBoundary extends Component<Props, State> {
  ...
  override componentDidCatch(error: Error, info: ErrorInfo): void {
    ...
    console.error('THE SURVEY crashed:', error, info.componentStack);
  }
