 ...
 * with the free-play host that is a playable frame (claude.md I10).
 */
declare global {
  interface Window {
    __brokersColdOpenMs?: number;
  }
}

requestAnimationFrame(() => {
  window.__brokersColdOpenMs = performance.now();
  performance.mark?.('brokers:playable');
});
